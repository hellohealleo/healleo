        ...
        {visibleTeamInsights.map((card, i) => (
          <div key={i} className="card" style={{
            ...
            <div style={{display:"flex",gap:10}}>
              <div style={{flexShrink:0,marginTop:2,cursor:"pointer"}} onClick={() => switchTab(card.action)}><Icon name={card.icon} size={22}/></div>
