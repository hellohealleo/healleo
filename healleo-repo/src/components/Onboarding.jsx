  ...
  return(<div style={{...S.app,display:"flex",alignItems:"center",justifyContent:"center",minHeight:"100vh"}}><style>{globalCSS}</style><div style={{background:"var(--card)",borderRadius:20,padding:36,maxWidth:520,width:"100%",boxShadow:"var(--shadow-lg)"}}>
    ...
    {step===0&&<div className="fade-up" style={{textAlign:"center",padding:"20px 0"}}>
      ...
      <p style={{fontSize:17,color:"var(--text)",maxWidth:420,margin:"0 auto",lineHeight:1.7,fontFamily:"var(--display)",fontWeight:400}}>
        Imagine having a doctor, dietitian, personal trainer, and therapist — all working together, all knowing your full story.
      </p>
    ...
    {step===1&&<div className="fade-up">
      ...
      <div style={{display:"flex",flexDirection:"column",gap:10,marginTop:16}}>
        {[
          ...
          {icon:"nutrition",title:"Healleo Nutrition",sub:"Your Dietitian",desc:"Builds meal plans from your actual body data — not generic advice. Knows how your meds and conditions affect what you should eat.",color:"var(--accent5)"},
          ...
          <div key={i} style={{display:"flex",gap:12,padding:"14px 16px",background:"var(--bg)",borderRadius:12,borderLeft:`3px solid ${pro.color}`}}>
            <div style={{flexShrink:0,marginTop:2}}><Icon name={pro.icon} size={48}/></div>
            <div>
      ...
      <p style={{fontSize:13,color:"var(--dim)",marginTop:14,textAlign:"center",lineHeight:1.5}}>They share what they learn — so your trainer knows about your meds, your dietitian knows about your labs, and your therapist knows about all of it.</p>
    ...
    {step===5&&<div className="fade-up" style={{padding:"10px 0"}}>
      ...
      <div style={{display:"flex",flexDirection:"column",gap:10}}>
        <div style={{padding:"12px 14px",background:"var(--bg)",borderRadius:10,borderLeft:"3px solid var(--accent3)"}}>
          <div style={{display:"flex",gap:8,alignItems:"center",marginBottom:4}}><Icon name="doctor" size={28}/><span style={{fontWeight:600,fontSize:14}}>Dr. Healleo</span></div>
        ...
        <div style={{padding:"12px 14px",background:"var(--bg)",borderRadius:10,borderLeft:"3px solid var(--accent5)"}}>
          <div style={{display:"flex",gap:8,alignItems:"center",marginBottom:4}}><Icon name="nutrition" size={28}/><span style={{fontWeight:600,fontSize:14}}>Dietitian</span></div>
          <p style={{fontSize:13,color:"var(--dim)",lineHeight:1.5,fontStyle:"italic"}}>{
        ...
        <div style={{padding:"12px 14px",background:"var(--bg)",borderRadius:10,borderLeft:"3px solid var(--accent4)"}}>
          <div style={{display:"flex",gap:8,alignItems:"center",marginBottom:4}}><Icon name="trainer" size={28}/><span style={{fontWeight:600,fontSize:14}}>Trainer</span></div>
          <p style={{fontSize:13,color:"var(--dim)",lineHeight:1.5,fontStyle:"italic"}}>{
        ...
        <div style={{padding:"12px 14px",background:"var(--bg)",borderRadius:10,borderLeft:"3px solid var(--accent2)"}}>
          <div style={{display:"flex",gap:8,alignItems:"center",marginBottom:4}}><Icon name="therapist" size={28}/><span style={{fontWeight:600,fontSize:14}}>Therapist</span></div>
          <p style={{fontSize:13,color:"var(--dim)",lineHeight:1.5,fontStyle:"italic"}}>{
