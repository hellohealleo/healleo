...
Be precise with the supplement name — use the standard supplement name (e.g. "Vitamin D3" not "cholecalciferol" unless it's a specialty product).` }
  ...
  return <div className="fade-up"><h2 style={S.h2}><Icon name="meds" size={18}/> Supplements</h2>

  {/* Camera scan */}
  <div style={{...S.card,marginTop:14,padding:16,borderLeft:"3px solid var(--accent2)"}}>
    <div style={{display:"flex",justifyContent:"space-between",alignItems:"center"}}>
      <div><h3 style={S.h3}><Icon name="camera" size={16}/> Scan Supplement Bottle</h3><p style={{fontSize:14,color:"var(--dim)",marginTop:2}}>Take a photo of the label to auto-log</p></div>
    ...
    {scanResult&&!scanResult.error&&<div style={{marginTop:10,padding:12,background:"rgba(107,90,36,0.07)",borderRadius:8,border:"1px solid rgba(107,90,36,0.15)"}}>
      ...
      {scanResult.directions&&<div style={{fontSize:16,color:"var(--dim)",marginTop:4,lineHeight:1.4}}><Icon name="summary" size={14}/> {scanResult.directions}</div>}
