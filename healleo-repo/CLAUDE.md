...
**Tier 1 � Zero effort (automatic, no user action)**
...
**Tier 2 � One tap (confirm, don't create)**
...
**Tier 3 � Conversational (one input, multiple data points)**
...
- The NL logging feature already exists � it should be the PRIMARY entry method, not an alternative buried in the UI.

**Tier 4 � Ambient intelligence (infer, don't ask)**
...
**Tier 5 � Periodic smart prompts (right question, right time)**
